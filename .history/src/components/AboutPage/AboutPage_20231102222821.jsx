                                ...
                                <div class="card-subtitle">
                                    <p>
                                        ...
                                        <small class="text-muted">
                                            {" "}
                                            {isEnglish
                                                ? "توسعه مفهوم الوساطة التأمينية فى مصر لتصبح عمليةتحليل ودراسة  متكاملة للمخاطر التى يتعرض لها عملائنا وليس مجرد عملية بيع منتجات تأمينية":"To expend The Concept Of insurance Brokerage in Egypt To Be a Full Risk Analysis Process from A:Z Not Just a Selling Process For insurance Products"
                                                }
                                        </small>{" "}
                                    </p>
                                </div>
