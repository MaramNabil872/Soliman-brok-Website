                                ...
                                <div class="card-subtitle">
                                    <p>
                                        ...
                                        <small class="text-muted">
                                            {" "}
                                            {isEnglish
                                                ? " مصر لتصبح عمليةتحليل ودراسة  متكاملة للمخاطر التى يتعرض لها عملائنا وليس مجرد عملية بيع منتجات تأمينية"
                                    ...
                                    <p>
                                        ...
                                        <small class="text-muted">
                                            ...
                                            <li class="cardText">
                                                ...
                                                <br />
                                                {isEnglish
                                                    ?  "نلتزم بكل التفاصيل الصغيرة لتقديم اعلى حماية لعملائنا ":" Commitment to the smallest details to offer the maximum Protection For our Clients"
                                                    }
                                            </li>
                                        </small>{" "}
                                    </p>
