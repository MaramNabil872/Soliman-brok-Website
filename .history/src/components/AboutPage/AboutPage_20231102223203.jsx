                                ...
                                <div class="card-subtitle">
                                    <p>
                                        ...
                                        <small class="text-muted">
                                            {" "}
                                            {isEnglish
                                                ? "To help Our Clients To have The Best possible insurance protection That Meets their needs.":"أن نقدم ل  عملائنا أوسع و أشمل حماية تأمينية تتناسب مع إحتياجاتهم  "
                                                }
                                        </small>{" "}
                                    </p>
                                </div>
                                ...
                                <div class="card-subtitle">
                                    <p>
                                        ...
                                        <small class="text-muted">
                                            {" "}
                                            {isEnglish
                                                ?"To expend The Concept Of insurance Brokerage in Egypt To Be a Full Risk Analysis Process from A:Z Not Just a Selling Process For insurance Products": "توسعه مفهوم الوساطة التأمينية فى مصر لتصبح عمليةتحليل ودراسة  متكاملة للمخاطر التى يتعرض لها عملائنا وليس مجرد عملية بيع منتجات تأمينية"
                                                }
                                        </small>{" "}
                                    </p>
                                </div>
                                    ...
                                    <p>
                                        ...
                                        <small class="text-muted">
                                            <li class="cardText">
                                                ...
                                                <br />
                                                {isEnglish
                                                    ? "(First & Formost) By Providing a unique Service To Our Clients Befor & After Selling.": "   اولا و دائما عن طريق تقديم خدمة متميزة جدا لعملائنا قبل وبعد البيع "
                                                    }
                                            </li>
                                            <li class="cardText">
                                                <strong>
                                                    {" "}
                                                    {isEnglish
                                                        ? "Satisfaction": "رضاء العملاء"
                                                        }
                                                </strong>{" "}
                                                <br />
                                                {isEnglish
                                                    ? "Our Clients Satisfaction is our only Priority & Our First Goal": "رضاء و حماينه عملائنا  هو اولويتنا الوحيدة وهدفنا الأول "
                                                    }
                                            </li>
                                            <li class="cardText">
                                                <strong>
                                                ...
                                                <br />
                                                {isEnglish
                                                    ? " Commitment to the smallest details to offer the maximum Protection For our Clients": "نلتزم بكل التفاصيل الصغيرة لتقديم اعلى حماية لعملائنا "
                                                    }
                                            </li>
                                        </small>{" "}
                                    </p>
