                                    ...
                                    <p>
                                        ...
                                        <small class="text-muted">
                                            ...
                                            {isEnglish
                                                ...
                                                رؤيتنا توسعه مفهوم الوساطة التأمينية فى مصر لتصبح عمليةتحليل ودراسة  متكاملة للمخاطر التى يتعرض لها عملائنا وليس مجرد عملية بيع منتجات تأمينية
                                                "}
                                        </small>{" "}
                                    </p>
                                </div>
                                        ...
                                        <small class="text-muted">
                                            <li class="cardText">
                                                ...
                                                {isEnglish
                                                    ...
                                                    : "(أولاً وقبل كل شيء) من خلال تقديم خدمة فريدة لعملائنا قبل وبعد البيع."}
                                            </li>
                                            <li class="cardText">
                                                <strong>
                                                    {" "}
