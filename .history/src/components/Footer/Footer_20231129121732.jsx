...
{isEnglish
                            ? " In case of having a complaint you have the right to escalate it to the Financial Regulatory Authority's head    office or through their website  "
                            : "و في حالة انتهاء مدة حل الشكوى أو عدم رضاء العميل عن التعامل مع شكواه داخل الشركة يحق له تصعيد شكواه إلى مقر الهيئة العامة للرقابة المالية أو عبر موقعها رضائك عن الخدمة وعدم قدرة الفريق على  حل الشكوى يمكنك تصعيد الشكوى لمقر الهيئة العامة للرقابة المالية أو عبر موقعها الإلكتروني "}{" "}
                        <br />{" "}
