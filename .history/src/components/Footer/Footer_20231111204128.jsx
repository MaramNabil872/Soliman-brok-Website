                ...
                <div className="container p-4">
                    <div className="row mt-4">
                        <div className="col-lg-4 col-md-12 mb-4 mb-md-0 text-lg-start">
                            ...
                            <p>  {isEnglish ? "Privacy Policy" : "سياسة الخصوصية "}</p>
                       
                            <p>  {isEnglish ? "Terms & Conditions" : "الأحكام والشروط"}</p>
                        ...
                        <div className="col-lg-4 col-md-6 mb-4 mb-md-0 text-center ">
                            <h5 className=" mb-4">  {isEnglish ? "PAYMENT METHODS" : "طرق الدفع"} <br/>  {isEnglish ? "(Installments)" : "(التقسيط)"}</h5>
<div className="contaner">
                ...
                >
                    <p className="size">
                        {" "}  {isEnglish ? " In case of having a complaint you have the right to escalate it to the Financial Regulatory Authority's head    office or through their website  " : "في حالة عدم رضائك عن الخدمة وعدم قدرة الفريق على مساعدتك يمكنك تصعيد الشكوى لمقر الهيئة العامة للرقابة المالية أو عبر موقعها الإلكتروني "} <br/> <a href="www.fra.gov.eg"  style={{ color: "#1BA7BD" }}>         www.fra.gov.eg{" "}     </a>
                       
                        <br />  {isEnglish ? "Mahmoud Soliman insurance brokerage is licenced by the Financial Regulatory Authority with FRA code 23019" : "FRA 23019  محمود سليمان لوساطة التأمين مرخصة من قبل هيئة الرقابة المالية برمز "} 
                    </p>
                </div>
