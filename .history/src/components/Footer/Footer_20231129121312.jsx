                ...
                >
                    <span className="size">
                        ...
                        {isEnglish
                            ...
                            : "  او تقديمها يدوياً إلى مقر الشركة Mahmoud@SolimanBrok.Com  و في حالة وجود شكوى لدى العميل يحق له أولاً تقديمها الى الشركة عبر الخط الساخن 01226303959 او البريد الإليكتروني  "}{" "} 
...
{isEnglish
                            ? " In case of having a complaint you have the right to escalate it to the Financial Regulatory Authority's head    office or through their website  "
                            : "و في حالة عدم رضائك عن الخدمة وعدم قدرة الفريق على  حل الشكوى يمكنك تصعيد الشكوى لمقر الهيئة العامة للرقابة المالية أو عبر موقعها الإلكتروني "}{" "}
                        <br />{" "}
