            ...
            <div className="post-text p-4 col-8" dir="auto">
                ...
                <div className="post-description">
                    ...
                    {isEnglish
                        ...
                        {isEnglish
                        ? " MEDICAL INSURANCE"
                        : "  4-إرتفاع معدل الوعى التأمين لدى الجمهور نتيجة ماسبق ويطلق على هذا النوع كلمة تكميلى للتفرقة بينة و بين تأمين السيارات الإجبارى الذى يتم إصدارة على السيارة فى وحدات المرور حيث ان هذا النوع يصدر عن طريق المحمعه  المصرية للتأمين الإجبارى عن المسئولية المدنية الناشئة عن حوادث  السيارت وليس عن طريق شركات التأمين مباشر"}
                </div>
