                ...
                <div className="row">
                    <div className="col-4">
                        <div class="blog ">
                            ...
                            <div class="info">
                                <span>
                                {isEnglish ? "For Our Clients""We help our Client To Define Discover & Calculate all the prospected Risks may face his Business Today Before Tomorrow" : "لعملائنا"}
                                </span>
                            </div>
                            <div class="footer">
