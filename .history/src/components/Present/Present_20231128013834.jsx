...
<div className=" " id="contain">
  ...
  <div class="row">
    ...
    <img src={first} alt="Photo of sunset" className="m-4 w-50 photo"/>
        <h5 class=" m-4 card-title-3">Sierra Web Development • Owner</h5>
        <p class="m-4">This is a company that builds websites, web apps and e-commerce solutions.</p> 
  </div>
    </div>
    <div class="col-md-4 col-sm-6">
      <div class="card card-block cards-3">
   
    <img src={second} alt="Photo of sunset" className="m-4 w-50 photo"/>
        <h5 class="  m-4 card-title-3">ProVyuh</h5>
        <p class="m-4">This is a company that builds websites, web .</p> 
  </div>
    </div>
    <div class="col-md-4 col-sm-6">
      <div class="card card-block cards-3">
    
    <img src={third} alt="Photo of sunset" className="m-4 w-50 photo"/>
        <h5 class="  m-4  card-title-3 ">ProVyuh</h5>
        <p class="m-4">This is a company that builds websites, web apps and e-commerce solutions.</p> 
  </div>
    </div>
