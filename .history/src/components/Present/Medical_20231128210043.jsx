                        ...
                        <div className="post-description">
                            {isEnglish
                                ...
                                :"لأن التأمين الطبى هو أحد أهم أنواع التأمين و أكثرهم تأثيرا مباشرا على الأفرد "}
                                 <br/> {isEnglish ? " MEDICAL INSURANCE" : "  لذلك نحن مختلفون ومتميزون"}
                                 <br/>{isEnglish ? " MEDICAL INSURANCE" : "فى سليمان بروك نقدم خدمات فنية إحترافية لعملائنا من أفضل شركات التأمين وأفضل مديرى الخدمات الطبية  المتخصصة والمتميزة فى التأمين الطبى  قبل وبعد البيع من خلال مدير حساب محترف لكل عميل من عملاؤنا "}
                        </div>
                        <div className="post-title1 mt-3" dir="auto">
                            {" "}
                            {isEnglish ? "INCLUDE THE FOLLOWING" :  "خدماتنا تشمل ما يلي  "}
                        </div>
                        <div className="post-description ">
                        {isEnglish ? " MEDICAL INSURANCE" : "أولا:تصميم جدول المزايا الحاص بكل عميل "}
                        </div>
                    </div>
                </div>
            </div>
