            ...
            <div className=" " id="contain">
                ...
                <div className="row">
                    ...
                    <div className="col-4">
                        <div class="blog ">
                            <div class="title-box">
                                <h3>  {isEnglish ? "Claim Handling" : "تسوية التعويضات"}</h3>
                                <hr />
                                {/* <div class="intro">
                                    Yllamco laboris nisi ut aliquip ex ea
                                    commodo.
                            ...
                            <div class="info">
                                <span>
                                {isEnglish ? "Starting From Claim Notification Ending With Delivering You The Claim Check" : "نلتزم بتناول ملف التعويض نيابة عن العميل من اللحظة الولى لوقوع الحادث حتى تسليم شيك التعويض ليد العميل "}
                                </span>
                            </div>
                            <div class="footer">
                                <div class="icon-holder">
