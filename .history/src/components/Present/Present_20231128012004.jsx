...
<div className=" " id="contain">
  ...
  <div class="row">
    ...
    <img src="https://static.pexels.com/photos/262550/pexels-photo-262550.jpeg" alt="Photo of sunset" className=""/>
        <h5 class="card-title  mt-3 mb-3 card-title-3 ">ProVyuh</h5>
        <p class="card-text">This is a company that builds websites, web apps and e-commerce solutions.</p> 
  </div>
    </div>
