                    ...
                    <div className="post-text p-4 col-8" dir="auto">
                        ...
                        <div className="post-description">
                            {isEnglish
                                ...
                                : "لأن التأمين الطبى هو أحد أهم أنواع التأمين و أكثرهم تأثيرا مباشرا على الأفرد  فى سليمان بروك نقدم خدمات فنية إحترافية لعملائنا من أفضل شركات التأمين وأفضل مديرى الخدمات الطبية  المتخصصة والمتميزة فى التأمين الطبى  قبل وبعد البيع من خلال مدير حساب محترف لكل عميل من عملاؤنا"}
                                  {isEnglish ? " MEDICAL INSURANCE" : "التأمين الطبى"}
                                  {isEnglish ? " MEDICAL INSURANCE" : "التأمين الطبى"}
                        </div>
                    </div>
