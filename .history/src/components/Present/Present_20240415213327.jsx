                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="card card-block cards-3 mb-4">
                                <img
                                    src={first}
                                    alt="Photo of sunset"
                                    className="m-3 w-50 photo"
                                />
                              <h5 class="  m-3 card-title-3">
                                    {" "}
                                    {isEnglish
                                        ? "Insurance solutions"
                                        : "  الحلول التأمينية "}
                                </h5>
                                <p class="m-3  card-text-3">
                                {isEnglish
                                    ...
                                    {isEnglish
                                        ...
                                        : " نقدم مجموعه متنوعه من عروض الأسعار من شركات التأمين المتميزة والمتخصصة في كل مجال  "}
                            ...
                            <div class="card card-block cards-3">
                                ...
                                <br />
                                    {isEnglish
                                        ...
                                        : " نقدم مقارنة تفصيلية فنية وسعرية لمساعدة العميل في إتخاذ القرار المناسب"}
                                    <br />
                                    {isEnglish
                                        ? "4- Issuing, reviewing all Realated Document To our Clients"
                                        : " إ ثم أصدار الوثائق و مرجعتها و تسليمها للعملاء "}
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="card card-block cards-3">
                                <img
                                    ...
                                    className="m-3 w-50 photo"
                                />
                                <h5 class="  m-3  card-title-3 "> {isEnglish
                                        ? "Claim Handling"
                                        : "تسوية التعويضات"}</h5>
