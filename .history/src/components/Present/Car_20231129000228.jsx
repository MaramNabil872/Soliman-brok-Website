                    ...
                    <div className="container-post row">
                        ...
                        <div className="post-text p-4 col-8" dir="auto">
                            ...
                            <div className="post-description">
                                ...
                                {isEnglish
                                    ? " MEDICAL INSURANCE"
                                    : " 2-نمو نشاط التمويل البنكى والإستهلاكى والتأجيرى وما ترتب علية الحاجة إلى ضمان حقوق الجهات الممولة"}<br/>
                                {isEnglish
                                    ? " MEDICAL INSURANCE"
                                    : " 3-ألإرتفاع الكبير فى أسعار قطع الغيار وتكاليف إصلاح السيارات  "}<br/>
                                {isEnglish
                                    ? " MEDICAL INSURANCE"
                            ...
                            <div className="post-description ">
                                ...
                                <br />
                                <span>
                                    حيث نساعد المالك أو مدير الموارد البشرية لدى
                                    عملاؤنا لتصميم جدول المنافع والمزايا التى
                                    تناسب إتيجاتة و الميزانية الخاصة به
                                </span>
                                <br />-<span>ثانيا : عروض الأسعار</span>
                                <br />
                                <span>
                                    {" "}
