                        ...
                        <li className="nav-item dropdown ">
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <a
                                        ...
                                        href="/Post/1"
                                    >
                                         {isEnglish ?  "Why":" لماذا" } Medical insurance
                                    </a>
                                </li>
                                <li>
                                <a
                                        ...
                                        href="/Post/2"
                                    >
                                         {isEnglish ?  "Why":" لماذا" } Motor Insurance
                                    </a>
                                </li>
                                <li>
                                <a
                                        ...
                                        href="/Post/3"
                                    >
                                        {isEnglish ?  "Why":" لماذا" }  Property Insurance
                                    </a>
                                </li>
                                <li>
                                    <a
                                        ...
                                        href="/Post/4"
                                    >
                                       {isEnglish ?  "Why":" لماذا" }   Marine Insurance
                                    </a>
                                </li>
                                <li>
                                    <a
                                        ...
                                        href="/Post/5"
                                    >
                                         {isEnglish ?  "Why":" لماذا" } Engineering Insurance
                                    </a>
                                </li>
                                <li>
                                <a
                                        ...
                                        href="/Post/6"
                                    >
                                         {isEnglish ?  "Why":" لماذا" } Liability Insurance
                                    </a>
                                </li>
                                <li>
                                <a
                                        ...
                                        href="/Post/7"
                                    >
                                          {isEnglish ?  "Why":" لماذا" }Life Insurance
                                    </a>
                                </li>
                                <li>
                                <a
                                        ...
                                        href="/Post/8"
                                    >
                                       {isEnglish ?  "Miscellaneous Insurance":" لماذا" }  
                                    </a>
                                </li>
                            </ul>
                        </li>
