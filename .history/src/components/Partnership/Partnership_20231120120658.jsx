    ...
    return (
        ...
        <div className="p-4 bgcolor " style={{}}>
            ...
            <div className="row justify-content-center text-center mb-4">
                ...
                <div className="col  m-4 service rounded-lg text-center">  <div className="col  m-4 service rounded-lg text-center bg-white img-items" style={{borderRadius:"15%", padding:"1%"}}>
                    <img
                       className="w-100  text-center img-items " 
                       src={allianz}
                    />
                ...
                <div className="col   m-4 service rounded-lg text-center">
                    <img
                       className="w-100  text-center img-items " 
                       src={libano}
                    />
