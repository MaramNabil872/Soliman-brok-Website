    ...
    return (
        ...
        <div className=" bgcolor " style={{}}>
            ...
            <div className="row justify-content-center ">
                <div className="col-12 col-lg-1 col-md-4  m-4 rounded-lg img-items" style={{borderRadius:"15%"}}>
                    <img
                       className="w-75 text-center img-items " 
                        src={axa}
                ...
                <div className="col-12 col-lg-21 col-md-4  m-4 service rounded-lg text-center  img-items" style={{borderRadius:"15%", padding:"1%"}}>
                    <img
                       className="w-75  text-center img-items " 
                       src={allianz}
                    />
                ...
                <div className="col-12 col-lg-2 col-md-4  m-4 service rounded-lg text-center  img-items" style={{borderRadius:"15%", padding:"1%"}}>
                    <img
                       className="w-75  text-center img-items " 
                       src={libano}
                    />
                ...
                <div className="col-12 col-lg-2 col-md-4  m-4 service rounded-lg text-center  img-items" style={{borderRadius:"15%", padding:"1%"}}>
                    <img className="w-75  text-center img-items " src={arope} />
                  
                </div>
                <div className="col-12 col-lg-2 col-md-4  m-4 service rounded-lg text-center img-items" style={{borderRadius:"15%", padding:"1%"}}>
                    <img className="w-75  text-center img-items "  src={metlife} />
                   
                </div>
                </div>
                <div className="row justify-content-center text-center">
                <div className="col-12 col-lg-1  m-4 service rounded-lg text-center  img-items" style={{borderRadius:"15%", padding:"1%"}}>
                    <img
