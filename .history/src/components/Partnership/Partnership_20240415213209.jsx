...
import mic from "./../../assets/images/mic1.jpg";
            ...
            <div className="p-4 bgcolor " style={{}}>
                ...
                <div className="container mb-4">
                    <div className="row justify-content-center text-center  all-items">
                        <div
                            className="col-12 col-lg-2 col-md-4  m-4 service rounded-lg text-center img-items card3"
                        ...
                        <div
                            className="col  m-4 service rounded-lg text-center  img-items  card3"
                            style={{ borderRadius: "15%", paddingTop: "4%" }}
                        >
                            <img
                                className="w-100  text-center img-items "
                                src={allianz}
                    ...
                    <div className="row justify-content-center text-center all-items">
                        ...
                        >
                            <img
                                className="w-100 mt-4  text-center img-items "
                                src={mic}
                            />
                        </div>
                        ...
                        <div
                            className="col   service rounded-lg text-center img-items  card3"
