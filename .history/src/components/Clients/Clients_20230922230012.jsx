...
const Clients = () => {
  ...
  <div className="carousel-item">
    <a href="#">
      <div className="carousel-item-image">
        <img src="https://f.i.uol.com.br/fotografia/2016/03/11/594620-970x600-1.jpeg" className="item-image"/>
      </div>
  ...
  <div className="carousel-item">
    <a href="#">
      <div className="carousel-item-image">
        <img src="https://f.i.uol.com.br/fotografia/2016/03/11/594616-970x600-1.jpeg" className="item-image"/>
      </div>
      <div className="carousel-item-text">
        <span className="item-kicker">Restaurante de São Paulo</span>
  ...
  <div className="carousel-item">
    <a href="#">
      <div className="carousel-item-image">
        <img src="https://f.i.uol.com.br/fotografia/2016/03/11/594617-970x600-1.jpeg" className="item-image"/>
      </div>
      <div className="carousel-item-text">
  ...
  <div className="carousel-item">
    <a href="#">
      <div className="carousel-item-image">
        <img src="https://f.i.uol.com.br/fotografia/2016/03/11/594619-970x600-1.jpeg" className="item-image"/>
      </div>
      <div className="carousel-item-text">
  ...
  <div className="carousel-item">
    <a href="#">
      <div className="carousel-item-image">
        <img src="https://f.i.uol.com.br/fotografia/2016/03/11/594618-970x600-1.jpeg" className="item-image"/>
      </div>
      <div className="carousel-item-text">
        <span className="item-kicker">Coxinha</span>
        <h3 className="item-title">Ragazzo</h3>
      </div>
    </a>
  </div>
  <div className="carousel-item">
    <a href="#">
      <div className="carousel-item-image">
        <img src="https://f.i.uol.com.br/fotografia/2016/03/11/594615-970x600-1.jpeg" className="item-image"/>
      </div>
      <div className="carousel-item-text">
        <span className="item-kicker">Cafeteria</span>
        <h3 className="item-title">Starbucks</h3>
      </div>
    </a>
  </div>
</div>
