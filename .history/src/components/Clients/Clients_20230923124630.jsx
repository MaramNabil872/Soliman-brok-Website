...
const Clients = () => {
  ...
  return (
    <>
          ...
          <div>
  <h1 className='text-center darkBl'>Reactjs OwlCarousel Working</h1>
<OwlCarousel className="slider-items owl-carousel " {...options}>
                      <div className="item client-logo"><img src={Mövenpick}/></div>
                      <div className="item client-logo"><img src={burgerking}/></div>
                      <div className="item client-logo"><img src={redcon}/></div>
                      <div className="item client-logo"><img src={german}/></div>
                      <div className="item client-logo"><img src={gpx}/></div>
                      <div className="item client-logo"><img src={system1}/></div>
                      <div className="item client-logo"><img src={modern}/></div>
                      <div className="item client-logo"><img src={bricks}/></div>
                      <div className="item client-logo"><img src={foodlover}/></div>
                      <div className="item client-logo"><img src={hi}/></div>
                      <div className="item client-logo"><img src={smartglass}/></div>
