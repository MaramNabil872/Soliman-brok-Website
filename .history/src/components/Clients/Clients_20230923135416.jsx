...
<OwlCarousel className="slide" {...options}>
                      <div className=" client-logo w-50"><img src={Mövenpick}/></div>
                      <div className=" client-logo w-50"><img src={burgerking}/></div>
                      <div className=" client-logo  w-50"><img src={redcon}/></div>
                      <div className=" client-logo  w-50"><img src={german}/></div>
