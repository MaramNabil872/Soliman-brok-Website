...
<OwlCarousel className="slider-items owl-carousel " {...options}>
                      <div class="item client-logo"><img src={Mövenpick}/></div>
                      <div class="item client-logo"><img src={burgerking}/></div>
                      <div class="item client-logo"><img src={redcon}/></div>
                      <div class="item client-logo"><img src={german}/></div>
                      <div class="item client-logo"><img src={gpx}/></div>
                      <div class="item client-logo"><img src={system1}/></div>
                      <div class="item client-logo"><img src={modern}/></div>
                      <div class="item client-logo"><img src={bricks}/></div>
                      <div class="item client-logo"><img src={foodlover}/></div>
                      <div class="item client-logo"><img src={hi}/></div>
                      <div class="item client-logo"><img src={smartglass}/></div>
                      <div class="item client-logo"><img src={Fujifilm}/></div>
                  </OwlCarousel>
</div>
