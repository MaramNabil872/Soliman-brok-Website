...
const WhoWeAre = () => {
    ...
    const about = [
     ...
     
        {
            ...
            title1: " حلول التأمين",
            text: "1- Setting / Designing The Appropriate insurance Covers & Conditions I Offering different offers From different insurance companies which have     The best capacity in the needed insurance Field    Offering a Professional & technical comparison to help our clients to take the right decision   Issuing, reviewing all Realated Document To our Clients  ",
        ...
        <>
            <div className=" " id="contain">
                <h2 className=" newcolor text-center">
                    {" "}
                    {isEnglish ? "What We Present" : "ما نقدمه"}
                </h2>
