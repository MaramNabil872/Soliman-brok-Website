...
<div class="row m-4 cardss">
  ...
  <div class="col-lg-3 col-sm-12 col-md-6">
    ...
    <h5 className='mt-4 Fonts medium-title'>  {isEnglish ? "loyalty" : "الولاء"}</h5>
      <p className=''>  {isEnglish ? "100% Of Our Loyalty is Only For Our Clients" : "لأن 100% من ولاءنا هو لعملائنا فقط"}</p>
    </div>
  </div>
...
<div class="row m-4 cardss">
  <div class="col-lg-3 col-sm-12 col-md-6">
    ...
    <h5 className='mt-4 Fonts medium-title'> {isEnglish ? "Zero" : "الاحترافيه اولا و دائما "}</h5>
      <span className=''> {isEnglish ? "Zero" : "الاحترافيه اولا و دائما "} </span>
      {/* <p className=''>  {isEnglish ? "cost to our Cients" : " تكلفة لعملائنا "}</p> */}
    </div>
  </div>
