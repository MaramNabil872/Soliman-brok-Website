...
const WhoWeAre = () => {
    ...
    const about = [
...

        {
            ...
            text1: "إعداد / تصميم الأغطية والشروط التأمينية المناسبة تقديم عروض مختلفة من شركات التأمين المختلفة التي لديها أفضل القدرات في مجال التأمين المطلوب تقديم مقارنة مهنية وفنية لمساعدة عملائنا على اتخاذ القرار الصحيح إصدار ومراجعة جميع المستندات ذات الصلة إلى عملائنا العملا",
        },
        {
