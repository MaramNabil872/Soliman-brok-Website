...
<div class="row m-4">
  ...
  <div class="col-lg-4 col-sm-12 col-md-6">
    ...
    <h5 className='mt-4 Fonts medium-title'>  {isEnglish ? "loyalty" : "الولاء"}</h5>
      <p className=''>  {isEnglish ? "100% Of Our Loyalty is Only For Our Clients" : "ان 100% من ولاءنا هو لعملائنا فقط"}</p>
    </div>
  </div>
...
<div class="row m-4">
  ...
  <div class="col-lg-4 col-sm-12 col-md-6 ">
    ...
    <img className='h-50 icons'src={employee} />
      ...
      <p className='lightWite'>  {isEnglish ? "More Than 5000 Clients Trusts Us" : "أكثر من 5000 عميل يثقون بنا"}</p>
    </div>
  </div>
