...
const WhoWeAre = () => {
    ...
    const about = [
...

        {
            ...
            text: "1- Setting / Designing The Appropriate insurance Covers & Conditions  3- Offering a Professional & technical comparison to help our clients to take the right decision  4- Issuing, reviewing all Realated Document To our Clients  ",
