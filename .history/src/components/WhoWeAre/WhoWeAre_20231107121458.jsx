...
const WhoWeAre = () => {
    ...
    const about = [
...

        {
            ...
            textAR: "١-نقدم تصور للتغطيات التأمينية التى يحتاجها عملائنا  ٣-نقدم مقارنة تفصيلية فنية وسعرية لمساعدة العميل فة إتخاذ القرار المناسب ٤-إصدار الوثائق و مرجعتها و تسليمها للعملاء",
