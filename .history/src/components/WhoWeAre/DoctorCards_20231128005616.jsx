                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text" dir="auto">
                                            {isEnglish
                                                ...
                                                : "نتابع عملية الإسترداد النقدى الخاصة بعملائنا بداية من أستلام الإسترداد من مقر العميل ثم مراجعتة ثم تسليمة لشركة التأمين حتى تسليم قيمة الأسترداد للعميل"}
                                        </p>
                                    </div>
                                </div>
                            </div>
