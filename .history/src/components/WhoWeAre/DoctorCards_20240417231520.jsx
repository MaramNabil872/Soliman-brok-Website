...
import "./Doctor.css";
import pie from "./../../assets/wsb/part-3.png";
import { useLanguageContext } from "../../Contexts/LanguageContext";
import soliman1 from "./../../assets/wsb/table.png";
import soliman2 from "./../../assets/wsb/offer.png";
import soliman4 from  "./../../assets/wsb/Card-4.png";
import soliman5 from  "./../../assets/wsb/Card-5.png";
import soliman6 from  "./../../assets/wsb/Card-6.png";
const DoctorCards = () => {
    const { setLanguage, isEnglish } = useLanguageContext();
    return (
        <div >
            <section className="pt-4 services-section bgcolor" id="services" >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text" dir="auto">
                                            ...
                                            {isEnglish
                                                ...
                                                : "حيث نقوم بمساعده العميل فى تحديد التغطيات الطبيه التى تناسب احتياجاته و ميزانيته  "}
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body" >
                                        ...
                                        <p class="card-text" dir="auto">
                                            ...
                                            {isEnglish
                                                ...
                                                : "نقدم مجموعه من  عروض أسعار من أكثر من شركة تأمين مع مقارنة فنية دقيقة لكل المزايا و الشروط لكى نساعدك لإخيار الأنسب و الأفضل لك"}
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text" dir="auto">
                                            {isEnglish
                                                ...
                                                : "نسهل لعملؤنا عملية الحصول على الموفقات الطبية من الألف إلى الياء للتأكد من إتمام الموافقة وفى الوقت المحدد لها"}
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text" dir="auto">
                                            {isEnglish
                                                ...
                                                : "نتابع عملية الإسترداد النقدى الخاصة بعملائنا بداية من أستلام الإسترداد من مقر العميل ثم مراجعتة ثم تسليمة لشركة التأمين حتى تسليم الأسترداد للعميل"}
                                        </p>
                                    </div>
                                </div>
                            </div>
