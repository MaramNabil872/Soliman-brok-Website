...
const WhoWeAre = () => {
    ...
    const about = [
...

        {
            ...
            text1: "١-نقدم تصور للتغطيات التأمينية التى يحتاجها عملائنا  ٢-نقدم مجموعه متنوعه من عروض الأسعار من شركات التأمين المتميزة والمتخصصة غلا مجال  ٣-نقدم مقارنة تفصيلية فنية وسعرية لمساعدة العميل فة إتخاذ القرار المناسب ٤-إصدار الوثائق و مرجعتها و تسليمها للعملاء",
        },
        {
