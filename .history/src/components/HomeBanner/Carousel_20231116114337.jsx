...
const Carousel = () => {
  ...
  return (
    ...
    <div>
  <h1 className='client-title m-4 titleBlue'>  {isEnglish ? "Clients who trust us" : "هؤلاء يثقوا بنا"}</h1>
...
Banner1                      <div class="item mt-4"><img src="https://mma.prnewswire.com/media/621161/GPX_Global_Systems_Inc.jpg?p=facebook"/></div>
