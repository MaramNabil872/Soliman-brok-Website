...
<form className="mt-4" ref={form} onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="row mb-4">
        ...
        <div className="col">
          ...
          <input
            type="text"
            className="form-control  image-border"
            placeholder=   {isEnglish ? "Mobile no." : "--رقم الهاتف المحمول--"}
            {...register("mobile", {
              required: true,
              pattern: /^\d(?:[- ]*\d){9}$/,
            })}
    ...
    <div className="container p-4  bgcolor rounded mx-4">
            ...
            <p className="text-center ">
            {isEnglish ? " Get in Touch for any Type of insurance Services." : " تواصل معنا للإستفسار عن على أي نوع من خدمات التأمين.  "} 
            </p>
