  ...
  <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
    ...
    <span className="visually-hidden">Next</span>
            ...
            <div className="row " dir="auto">
                <div
                    className="col p-4 m-4 d-flex"
                    style={{ alignSelf: "center" }}
                >
                    <div className="container p-4  bgcolor rounded">
                        <div className="text-center mt-4 small-title"  style={{  color:" #37517E;"}}>
                            {" "}
                            {isEnglish
                                ? "Ask For Motor Quotation"
                                : " اسأل عن تأمين سيارتك"}
                        </div>
                        ...
                        >
                            ...
                            <p className="text-center">
                                {" "}
                                {isEnglish ? "Viechle info" : " بيانات السيارة"}
                            </p>
                            <div className="row mb-4">
                                <div className="col ">
                                    <input
                    ...
                    <div className="container p-4  bgcolor rounded mx-4">
                        <h3 className="text-center mt-4 small-title">
                            {isEnglish ? "Send us a message" : "أرسل رسالة "}
                        </h3>
                        <p className="text-center xmall-text">
                            {isEnglish
                                ? " Get in Touch for any Type of insurance Services."
                                : " تواصل معنا للإستفسار عن انواع التأمين الأخرى .  "}
                        </p>
                        <form
                            className="m-4 "
                            onSubmit={handleSubmit(onSubmit)}
