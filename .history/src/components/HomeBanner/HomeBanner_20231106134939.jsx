...
<div className="row ">
        <div className="col p-4 m-4 d-flex" style={{ alignSelf: "center" }}>
          <div className="container p-4  bgcolor rounded">
            <h3 className="text-center mt-4 ">Ask For Motor Quotation</h3>
...
<form className="mt-4" ref={form} onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="row mb-4">
        ...
        <input
            type="email"
            className="form-control image-border"
            placeholder=   {isEnglish ? "Email-address" : " --البريد الألكتروني--"}
            {...register("email", {
              required: true,
              pattern: /^[^@ ]+@[^@ ]+\.[^@ .]{2,}$/,
            })}
    ...
    <div className="row mb-4">
        <div className="col ">
          <input
            type="text"
            className="form-control  image-border"
            placeholder=   {isEnglish ? "Home" : " --نوع السياره--"}"Manufacture"
            {...register("firstName")}
          />
        </div>
        </div>
        ...
        <div className="col ">
          <input
            type="text"
            className="form-control  image-border"
            placeholder=   {isEnglish ? "Home" : " --الموديل--"}"Version"
            {...register("firstName")}
          />
        </div>
        </div>
        ...
        <div className="col ">
          <input
            type="text"
            className="form-control  image-border"
            placeholder=   {isEnglish ? "Home" : " سنة الصنع"}"Year of Manufacture"
            {...register("firstName")}
          />
        </div>
        </div>
        ...
        <div className="col ">
          <input
            type="text"
            className="form-control  image-border"
            placeholder=   {isEnglish ? "Home" : " القيمه السوقيه"}"Market Value"
            {...register("firstName")}
          />
        </div>
        </div>
