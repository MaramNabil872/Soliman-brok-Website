  ...
  useLanguageContext();
    return (
      <div className="p-4 " style={{}}>
        ...
        <div className="row justify-content-center text-center col-3 container">
          <div>
          <h5 id="service-title " className="text-start pt-2 text-center">
          {isEnglish ? "Property Insurance" : "تأمين الممتلكات "} 
      </h5>     
      <img className="w-100 h-75 text-center"  src="https://www.propertyfinder.eg/property/426789565ef00a505f3b953a602a9734/668/452/MODE/ccd6a8/3209861-ca3e8o.jpg?ctr=eg"/>
            </div>
          <ServiceItem
