    ...
    return (
      <div className="p-4 " style={{}}>
        ...
        <div className="row justify-content-center text-center">
          <ServiceItem
            title=        {isEnglish ? "Property Insurance" : "تأمين الملكية "} 
            imageSource="https://www.propertyfinder.eg/property/426789565ef00a505f3b953a602a9734/668/452/MODE/ccd6a8/3209861-ca3e8o.jpg?ctr=eg"
          />
          <ServiceItem
        ...
        <div className="row justify-content-center text-center">
          ...
          />
          <ServiceItem
            title={isEnglish ? "Liability Insurance" : "تأمين المس"}
          ...
          />
            <ServiceItem
            title={isEnglish ? "Miscellaneous Insurance" : "تأمين متنوع"}
