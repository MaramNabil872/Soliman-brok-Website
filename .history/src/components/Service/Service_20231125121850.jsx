        ...
        <div className="p-4  " style={{}}>
            ...
            <div className="row justify-content-center text-center">
                <div className="col-12 col-lg-2 col-md-4  m-4 service rounded-lg text-center">
                    <img
                        className="w-75 h-50 text-center"
                        src={prop}
                    />
                      <br/>
                    <Link
                ...
                <div className="col-12 col-lg-2 col-md-4  m-4 service rounded-lg text-center">
                    <img
                        className="w-750 h-50 text-center"
                        src={car}
                    />
                      <br/>
                    <Link
                ...
                <div className="col-12 col-lg-2 col-md-4  m-4 service rounded-lg text-center">
                    <img className="w-750 h-50 text-center" src={marine} />
                    <br/>
                    <Link
                        id="service-title "
                        to="/Post/4"
            ...
            <div className="row justify-content-center text-center">
                <div className="col-12 col-lg-2 col-md-4  m-4 service rounded-lg text-center">
                    <img className="w-750 h-50 text-center" src={eng} />
                    <br/>
                    <Link
                        id="service-title "
                        className="text-start pt-2 text-center text26 "
