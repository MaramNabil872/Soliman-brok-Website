    ...
    return (
        <div className="p-4  " style={{}}>
            ...
            <div className="row justify-content-center text-center">
                <div className="col-12 col-lg-1 col-md-4  m-4 service rounded-lg text-center">
                    <img
                ...
                <div className="col-12 col-lg-1 col-md-4  m-4 service rounded-lg text-center">
                    <img className="h-100 text-center" src={marine} />
                    <Link
                        id="service-title "
                        to="/Post/4"
                        className="text-start pt-2 text-center text26"
            ...
            <div className="row justify-content-center text-center">
                <div className="col-12 col-lg-2 col-md-4  m-4 service rounded-lg text-center">
                    <img className="w-100 h-75 text-center" src={eng} />
                    <Link
                        id="service-title "
                        className="text-start pt-2 text-center text26 "
                        to="/Post/5"
