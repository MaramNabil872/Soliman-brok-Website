            ...
            <div class="how-section1">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p>
                        هو احد الشروط الهامة الموجودة فى وثائق التأمين التى تتضمن اى نوع من انواع الممتلكات سواء كانت سياراتأو مبانى أو بضائع أو معدات ...إلخ
ظهرت أهمية هذا الشرط حديثا و أصبح من الضرورى  تعرف العملاء على هذا الشرط نتيجة للتغيرات المتلاحقة والمتسارعة فى المتغيرات الإقتصدية الكلية وأثارها علي التغير في قيمة األصول المؤمن عليها لدي شركات التأمين مقارنة بالقيم السوقية أو الإستبدالية من ناحية والأفساط المدفوعه من العملاء من ناحية 
أخرى و تأثير ذلك تبعا على التعويضات التى قد يستحقها العملاء
...
المبلغ المؤمن به، عندها يعتبر العميل (المؤمن له و/ أو المستفيد) بمثابة المؤمن لدى نفسه بالفرق بين القيمتين و يتحمل تبعاً لذلك نصيبه النسبى من الخسارة، ويخضع كل بند من بنود الوثيقة على حده - في حال تعددها- لمضمون شرط النسبية و علية 
1-فى حالة الخسارة الجزئية 
سيتحمل العميل جزء من التعويض يماثل نسبة الفرق بين القيميتين  
2- فى حالة الخسارة الكلية
 فإن شركة التأمين ستقوم بتعويض العميل بمبلغ التأمين المنصوص عليه في وثيقة التأمين أو القيمة السوقية أيهما أقل.
