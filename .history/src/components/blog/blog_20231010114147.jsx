...
<div class="bg-overlay">
    ...
    <br/><br/>
		<h1  className=" header1">Our Blog<br/></h1>
    ...
    <div class="how-section1">
                    <div class="row">
                        <div class="col-md-6 how-img">
                            <img src={blog1} class="rounded-circle img-fluid" alt=""/>
                        </div>
                        <div class="col-md-6">
                            <h4> لأصحاب المصانع و الشركات عايز تعمل تأمين و مش
                                عارف؟</h4>
                                        <h4 class="subheading">سليمان بروك للوساطة التأمينية بيقدم لك:</h4>
                        <p class="text-muted">   حلول تأمينيه للمخاطر المحتمله لنشاطك بيقدملك
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h4>بنقدم لك عرض الأسطورة للتأمين على الأسطول من
                                سليمان بروك</h4>
                                        <h4 class="subheading">سعار تنافسية تبدأ من 1.25% </h4>
                                        <p class="text-muted"> سرعة صرف التعويضات
                        ...
                        <div class="col-md-6 how-img">
                            <img src={blog2} class="rounded-circle img-fluid" alt=""/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 how-img">
                             <img src={blog3}class="rounded-circle img-fluid" alt=""/>
                        </div>
                        <div class="col-md-6">
                            <h4> أسرتك تستحق .. سيب التأمين يشيل</h4>
                                        <h4 class="subheading">لتأمين الطبى أصبح ضرورة مش رفاهية .. و مصاريف
                                العلاج أصبحت نار ..</h4>
