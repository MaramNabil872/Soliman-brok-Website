            ...
            <div class="how-section1">
                <div class="row">
                    <div class="col-md-6 how-img">
                        <img
                            src="https://i0.wp.com/www.archerinsgroup.com/wp-content/uploads/2020/12/What-Do-You-Need-to-Know-About-Car-Insurance-and-Fire-Damage.jpg?fit=2920%2C2000&ssl=1"
                    ...
                    <div class="col-md-6">
                        ...
                        <p>
                            ...
                            مبانى أو بضائع أو معدات ...إلخ{" "}
                        </p>{" "}
                        <br/>
                        <p>
                        ظهرت أهمية هذا الشرط حديثا و أصبح من الضرورى تعرف
                        العملاء على هذا الشرط نتيجة للتغيرات المتلاحقة
                        والمتسارعة فى المتغيرات الإقتصدية الكلية وأثارها علي
                        التغير في قيمة األصول المؤمن عليها لدي شركات التأمين
                        مقارنة بالقيم السوقية أو الإستبدالية من ناحية والأفساط
                        المدفوعه من العملاء من ناحية أخرى و تأثير ذلك تبعا على
                        التعويضات التى قد يستحقها العملاء</p>
                        ...
                        <p>
                            ...
                            التأمين) وأصبحت قيمتها السوقية 1.000.000 جنيه( فى
                            وقت وقوع الحادث) وعلية تكون السيارة مؤمن عليها لدى
                            شركة التأمين بنسبة 60% ولدى العميل بنسبة 40 % فى
                            حالة تحقق خسارة جزئية قيمتها قدرت 150.000 جنيه يكون
                            نصيب شركة التأمين من فاتورة التعويض
                            =150.000*60%=90.000 جنية فقط و ذلك بخلاف تطبيق باقى
                            شروط الوثيقة
                        </p>
                    </div>
                </div>
