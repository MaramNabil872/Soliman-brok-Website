...
const ContentPage = () => {
    type import Content from "../components/Blog/Content.json";
    = {
        title: string;
        image: string;
        id: string;
        ...
        useEffect(() => {
          ...
          switch (category) {
            case "0":
              ...
              break;
            case "1":
              const post1: any = Posts.fence.find((post1) => post1.id === itemID);
              if (typeof post1 === "object") {
                setItem(post1);
              }
              break;
            case "2":
              const post2: any = Posts.deck.find((post2) => post2.id === itemID);
