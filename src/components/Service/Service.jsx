...
const Services = () => {
    ...
    return (
        <div className=" " style={{}}>
            ...
            <div className="row justify-content-center text-center mb-4 first" dir="auto">
                <div className="col-12 col-lg-2 col-md-4 service rounded-lg text-center">
                    <img className="w-750 h-100 text-center" src={prop} />
                    <br />
                    <Link
                        onClick={scrollToTop}
                        id="service-title "
                ...
                <div className="col-12 col-lg-2 col-md-4  service rounded-lg text-center">
                    <img className="w-750 h-100 text-center" src={car} />
                    <br />
                    <Link
                        onClick={scrollToTop}
                        id="service-title "
                ...
                <div className="col-12 col-lg-2 col-md-4 service rounded-lg text-center"dir="auto">
                    <img className="w-750 h-100 text-center" src={Medical} />
                    <br />
                    <Link
                        onClick={scrollToTop}
                        id="service-title "
            ...
            <div className="row justify-content-center text-center mt-4 second"dir="auto">
                <div className="col-12 col-lg-2 col-md-4   service rounded-lg text-center">
                ...
                <div className="col-12 col-lg-2 col-md-4   service rounded-lg text-center">
                    <img className="w-750 h-100 text-center" src={Liability} />
                    <br />
                    <Link
                        onClick={scrollToTop}
                        id="service-title "
                ...
                <div className="col-12 col-lg-2 col-md-4  service rounded-lg text-center">
                    <img className="w-750 h-100 text-center" src={life} />
                    <br />
                    <Link
                        onClick={scrollToTop}
                        id="service-title "
                ...
                <div className="col-12 col-lg-2 col-md-4   service rounded-lg text-center">
                    <img className="w-750 h-100 text-center" src={mis} />
                    <br />
                    <Link
                        onClick={scrollToTop}
                        id="service-title "
